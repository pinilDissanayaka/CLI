 ...
 *
 * Usage:
 *   rise-cli --provider openai --model gpt-4o
 *   rise-cli --provider gemini --model gemini-2.0-flash
 *   rise-cli --provider mistral --model ministral-3b-latest
 *   rise-cli --provider ollama --model llama3.2
 *   rise-cli --provider anthropic   (default, no-op)
 */
