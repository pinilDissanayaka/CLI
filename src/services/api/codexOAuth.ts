...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Rise CLI now.</p>
    <p>Rise CLI will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Rise CLI.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Rise CLI.</p>
  </body>
</html>`
}
