/**
 * Rise CLI build script — bundles the TypeScript source into a single
...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.PACKAGE_URL': JSON.stringify('@gitlawb/rise-cli'),
...
if (!result.success) {
  ...
  console.log(`✓ Built rise-cli v${version} → dist/cli.mjs`)
}
