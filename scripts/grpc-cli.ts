...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/rise-cli.proto')
...
const riseCliProto = protoDescriptor.rise_cli.v1
...
async function main() {
  ...
  const client = new riseCliProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mRise CLI gRPC CLI\x1b[0m')
